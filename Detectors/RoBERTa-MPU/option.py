...
def get_parser():
    ...
    parser.add_argument('--local-data', type=str, default='/')
    parser.add_argument('--data-name', type=str, default='save')
    parser.add_argument('--model-name', type=str, default='/data5/storage4/wudauser05/yyc/roberta-base')
    ...
    parser.add_argument('--output_dir', type=str, default=None, help='store result')
