...
#  python preprocess/construct_graph.py --kw_file_dir /data/Coh-MGT-Detection-main/data/MAGE/specific/polish/qwen/uniPrompt/test_kws.jsonl
...
if __name__ == "__main__":
    ...
    tokenizer = RobertaTokenizer.from_pretrained(r"/data5/storage4/wudauser05/yyc/roberta-base", do_lower_case=False)
    max_seq_length = 512
    no_node = 0
