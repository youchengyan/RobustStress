    ...
    for i in range(start_index, total):
        ...
        try:
            if original_text.strip():
                prompt = (
                        "Rewrite this text in your own words, ensuring the core meaning remains identical, but using distinct phrasing and structure. The following text: " + original_text
                )
