    ...
    for i in range(start_index, total):
        ...
        try:
            if original_text.strip():
                prompt = (
                        "Paraphrase this text with minimal changes. "
                        "Only alter word choice or phrasing if absolutely necessary to sound natural. "
                        "Preserve every detail exactly. Output ONLY the paraphrased text, with no introductory sentences. The following text: " + original_text + "Paraphrased version:"
                )
